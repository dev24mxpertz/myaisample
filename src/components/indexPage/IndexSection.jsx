    ...
    <Scroll html className="w-full">
      <div className="Main_Layout_Container relative ">
            ...
            <Section>
              <div className="flex flex-col items-center">
                <div className="w-full secondboxbg rounded-md flex flex-col justify-center items-center p-4">
                  ...
                  >
                    The rate of change affecting businesses has risen over 183%
                    in the last 4 years. To counter this, 83% of organisations
                    have accelerated the execution of reinvention with GenAI.
                  </motion.p>
                </div>
                <motion.p
              ...
              <div className="w-full py-16">
                ...
                <div className="secondflexidv">
                  ...
                  >
                    ...
                    >
                      A company delivered 16 million personalized offerings to
                      their customers within 3 months.
                    </motion.p>
                  </motion.div>
                  ...
                  >
                    ...
                    >
                      An insurer increased the potential revenue by 10% using AI
                      in only one single function of the whole process.
                    </motion.p>
                  </motion.div>
                </div>
              </div>
              ...
              <div className="w-full py-8 ">
                ...
                <div className=" thirdflexidv">
                  ...
                  >
                    ...
                    <p>
                      Eliminate unique customer frustrations and operational
                      issues to deliver a seamless experience that keeps them
                      coming back, all while driving greater operational
                      efficiency and productivity with the custom AI assistant
                  ...
                  >
                    ...
                    <p>
                      ...
                      departments thrive, and employees are empowered to focus
                      on creativity and innovation—all driven by custom AI
                      solutions applicable throughout the value chain.
                    </p>
                    <motion.button
                      className="oursite_box_link"
                      initial={{ opacity: 0, y: 20 }}
        ...
        <div className={`menu_container ${IsMenuVisible ? "open" : ""}`}>
          <div className="w-full px-4 py-8 flex justify-between items-center">
